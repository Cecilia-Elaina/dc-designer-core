...
在仓库页面以 `v1.1.5` 标签创建 Release，附加：

- `dist/dc-designer-core-v1.1.5.zip`；
- `dist/dc-designer-core-v1.1.5.release.json`；
- `dist/dc-designer-core-v1.1.5.zip.sha256`（如果发布包目录中已生成）。
