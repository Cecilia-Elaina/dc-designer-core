...
在仓库页面以 `v1.1.3` 标签创建 Release，附加：

- `dist/dc-designer-core-v1.1.3.zip`；
- `dist/dc-designer-core-v1.1.3.release.json`；
- `dist/dc-designer-core-v1.1.3.zip.sha256`（如果发布包目录中已生成）。
