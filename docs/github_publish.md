...
在仓库页面以 `v1.1.0` 标签创建 Release，附加：

- `dist/dc-designer-core-v1.1.0.zip`；
- `dist/dc-designer-core-v1.1.0.release.json`；
- `dist/dc-designer-core-v1.1.0.sha256.txt`（如果发布包目录中已生成）。
